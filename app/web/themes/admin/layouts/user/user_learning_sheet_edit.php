...
<div id="DialogLearningSheetEdit" class="modal" role="dialog">
...
<?php /* SKILL EDIT DIALOG */ ?>
<div id="DialogLearningSkillEdit" class="modal" role="dialog">
	<div class="modal-dialog" role="document">
		<form class="modal-content" method="POST">
		<div class="modal-header">
			<h2 class="modal-title text-center w-100">
				<?php echo t('learningSkill.update.title', DOMAIN_LEARNING_SKILL); ?>
			</h2>
			<button type="button" class="close" data-dismiss="modal" aria-label="<?php echo t('close'); ?>">
				<span aria-hidden="true">&times;</span>
			</button>
		...
		<div class="modal-body">
			<div class="form-group">
				<label class="form-label" for="InputLearningSkillKey"><?php _t('key', DOMAIN_LEARNING_SKILL); ?></label>
				<input type="text" class="form-control modal-focus skill_key" id="InputLearningSkillKey" disabled>
			</div>
			<div class="form-group">
				<label class="form-label" for="InputLearningSkillName"><?php _t('name', DOMAIN_LEARNING_SKILL); ?></label>
				<input type="text" class="form-control modal-focus skill_name" id="InputLearningSkillName" <?php echo formInput('skill/name'); ?>
					   data-enter="click" data-target="#ButtonLearningSkillSave">
			</div>
			<div class="form-check">
				<input type="checkbox" class="form-check-input skill_valuable" id="InputLearningSkillValuable" <?php echo formInput('skill/valuable'); ?>>
				<label class="form-check-label" for="InputLearningSkillValuable">Cette compétence possède une valeur</label>
			</div>
		</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-outline-secondary" data-dismiss="modal"><?php echo t('cancel'); ?></button>
			<button type="submit" class="btn btn-primary action-save skill_id" name="submitSkill" id="ButtonLearningSkillSave"><?php echo t('save'); ?></button>
		</div>
		</form>
	</div>
</div>
...
<div id="DialogLearningSheetImport" class="modal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		...
		<div class="modal-body">
			...
			<p>
				L'import ne supporte que le format CSV (Excel, séparateur <b>;</b>) et il ne peut qu'ajouter de nouvelles compétences et de nouveaux
				domaines.<br>
