...
function requestAutocomplete(what, term, response, context) {
	...
	lastXhr = $.getJSON("/remote-search-what=" + what + "&term=" + term + (context ? "&context=" + context : "") + ".json", function (data, status, xhr) {
